...
const Home: NextPage = () => {
  ...
  function MintButton() {
    ...
    <div className="bg-black pb-16 flex flex-wrap buttom justify-center">
      ...
      <div className="m-12 lg:m-32 px-12 py-6 lg:pt-8 lg:px-20 border-2 bg-black text-center border-[#FFFFFF] bg-center bg-contain bg-no-repeat">
        <h1 className="text-2xl lg:text-4xl pt-2 lg:pt-4 lg:pb-6 text-white font-['Impact']">Avalanche MASKS NFT</h1>
        <h1 className="text-2xl lg:text-4xl pt-2 lg:pt-4 lg:pb-6 text-white font-['Impact']">PRICE: FREE</h1>
  ...
  return (
    <div>
      <Seo
          pageTitle={'Avalanche MASKS'}
          pageDescription={'Avalanche MASKS'}
          pageImg={''}
          pageImgWidth={1920}
          pageImgHeight={1005}
      />
